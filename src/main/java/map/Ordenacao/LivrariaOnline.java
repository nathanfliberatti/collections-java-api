...
public class LivrariaOnline {
    ...
    public List<String> obterLivroMaisCaro() {
        List<String> livrosMaisCaros = new ArrayList<>();
        ...
        for (Map.Entry<String, Livro> entry : livros.entrySet()) {
            if (entry.getValue().getPreco() == precoMaisAlto) {
                ...
                livrosMaisCaros.add(livroComPrecoMaisAlto.getTitulo());
            }
        }
        return livrosMaisCaros;
    }

    public List<String> obterLivroMaisBarato() {
        List<String> livrosMaisBaratos = new ArrayList<>();
        ...
        for(Map.Entry<String, Livro> entry : livros.entrySet()) {
            if (entry.getValue().getPreco() == precoMaisBaixo) {
                ...
                livrosMaisBaratos.add(livroComPrecoMaisBaixo.getTitulo());
            }
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("Livros do Autor: %s:\n %s\n",autorPesquisa,  livrariaOnline.pesquisarLivrosPorAutor(autorPesquisa));
        ...
        System.out.println("Livraria onine: \n" + livrariaOnline.livros);
    }
}
